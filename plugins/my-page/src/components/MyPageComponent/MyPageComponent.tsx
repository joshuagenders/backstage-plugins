...
export type MyPageComponentProps = {
  componentFactory: (id: string, props: React.PropsWithChildren<any>) => JSX.Element | null
  ids: string[]
  // schema?: Map<string, FormInputs[]>
}

export const ComponentFactoryContext = createContext<MyPageComponentProps>({ componentFactory: () => null, ids: [] })
